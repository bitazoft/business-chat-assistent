      ...
      <div className="bg-gradient-to-b from-[#1a1a2e] to-[#16213e] rounded-xl border border-gray-700 w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="productName" className="text-violet-400 font-medium">
              Product Name *
            </Label>
            <Input
              id="productName"
          ...
          {/* Price */}
          <div className="space-y-2">
            <Label htmlFor="productPrice" className="text-violet-400 font-medium">
              Price *
            </Label>
            <Input
              id="productPrice"
          ...
          {/* Stock */}
          <div className="space-y-2">
            <Label htmlFor="productStock" className="text-violet-400 font-medium">
              Stock Quantity *
            </Label>
            <Input
              id="productStock"
          ...
          {/* Description */}
          <div className="space-y-2">
            <Label htmlFor="productDescription" className="text-violet-400 font-medium">
              Description *
            </Label>
            <Textarea
